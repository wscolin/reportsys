            ...
            <div class="form-group" style="float:left">
                ...
                <div class="col-md-12 col-lg-12col-sm-12">
                    <shiro:hasPermission name="st_user_import">
                        <button class="btn btn-sm btn-default " id="btn_setresource" data-toggle="modal" onclick="provice_data.btn_import_click();"><i class="fa fa-upload"></i> 导入</button>
                    </shiro:hasPermission>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary" onclick="provice_data.btn_savefile_click(this);"><i class="fa fa-save"></i> 导入</button>
...
<script src="${ctx}/javascript/sys/excel_pro.js" type="text/javascript"></script>
