		...
		<div class="portlet light">
			<div class="portlet-title">
				<div class="actions">
					...
					<shiro:hasPermission name="st_user_set">
						<button class="btn btn-sm btn-success" id="btn_set" onclick="btn_set_click();"><i class="fa fa-cog"></i> 注销</button>
					</shiro:hasPermission>
					<shiro:hasPermission name="st_user_setrole">
						<button class="btn btn-sm green" id="btn_setresource" data-toggle="modal" onclick="btn_setrole_click();"><i class="fa fa-cog"></i> 用户授权</button>
						<button class="btn btn-sm blue" id="btn_setresource" data-toggle="modal" onclick="btn_setdeptrole_click();"><i class="fa fa-cogs"></i> 部门用户授权</button>
					</shiro:hasPermission>
...
<script src="${ctx}/javascript/sys/user.js" type="text/javascript"></script>
