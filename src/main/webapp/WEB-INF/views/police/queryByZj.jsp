        ...
        <div class="col-md-6">
            <div class="input-icon right" id="homeserch">
                ...
                <form id="frm" action="${ctx}/police/queryByPhoto">
                    <input name="zzlx" type="text" class="form-control input-circle" placeholder="证照类型代码" value="${identity}">
                    <input name="zzhm" type="text" class="form-control input-circle" placeholder="证照号码" value="">
                </form>
            </div>
        </div>
        <div class="col-md-3"></div>
